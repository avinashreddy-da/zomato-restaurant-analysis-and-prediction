...
- 🧠 Identify meaningful restaurant segments such as Hidden Gems, Top Performers, Overhyped and  underperforming restaurants
...
Created restaurant segmentation feature (Underperforming Restaurants, Hidden Gems, Top Performers, Overhyped)
...
## 🔍 Key Insights
- The restaurant dataset shows a clear imbalance in segment distribution with Underperforming Restaurants dominating, followed by Hidden Gems, Top Performers and Overhyped categories, indicating uneven restaurant quality across Hyderabad.
...
- Segment-wise analysis shows that Hidden Gems (~4.11) and Top Performers (~4.08) achieve the highest ratings, while Underperforming Restaurants (~3.86) and Overhyped (~3.77) perform lower in comparison. 
- Engagement analysis shows that Top Performers and Overhyped restaurants receive higher customer interaction, while Underperforming Restaurants dominate in count but have lower engagement levels. 
...
-	The primary focus of this analysis is to accurately identify Underperforming Restaurants, which represent underperforming listings with low ratings, low engagement or poor customer feedback. 
...
-	Overall, this dual insight (Underperforming Restaurants + Hidden Gems) helps create a balanced ecosystem, improving both customer satisfaction and restaurant fairness on the platform.
...
-	ML model effectively identifies Underperforming Restaurants with reasonable accuracy.
